...
function PdfReport({ inheritancePic, logo, ReduxStoredData, socialMediaPic }) {
      ...
      <Document>
        ...
        >
          ...
          <div style={{ width: "650px" }}>
            <div id="page" className={styles.backgroundTwo}>
              ...
              <div
                ...
                className={styles.overviewDesc}
              >
                The Expelee team has performed a line-by-line manual analysis
                and automated review of the smart contract. The smart contract
                was analysed mainly for common smart contract vulnerabilities,
                exploits, and manipulation hacks. According to the smart
                contract audit:
              </div>
          ...
          {ReduxStoredData?.description ? (
            <div
              style={{ width: "650px", height: "100%", position: "relative" }}
            >
              <div id="page" className={styles.backgroundTwo}>
                <div
                  style={{
                ...
                <div
                  style={{ position: "absolute", bottom: 850, left: "-35px" }}
                >
                  {logo && (
                    <img
                      style={{
...
socialMediaPic &&
            ...
            />
                ...
                <div style={{ marginLeft: "70px", marginTop: "-40px" }}>
                  {ReduxStoredData?.weblink ? (
                    <>
                      ...
                      <Link src="https://www.google.com">Google</Link>
                    </>
                  ) : null}
                  {/* <br /> */}
                ...
                >
                  ...
                  >
                    It’s always good to check the social profiles of the
                    project, before making your investment.
                  </p>
                  <p
                    style={{
                      fontSize: "30px",
                ...
                >
                  ...
                  <Grid
                    ...
                    sx={{
                      ...
                      textAlign: "center",
                      color: `${
                        ReduxStoredData?.Proxy === "Detected"
                          ? "red"
                          : "#00ff72"
                      }`,
                ...
                >
                  ...
                  <Grid
                    ...
                    sx={{
                      ...
                      textAlign: "center",
                      color: `${
                        ReduxStoredData?.arithmatic === "Passed"
                          ? "white"
                          : "red"
                      }`,
                  ...
                  <Grid
                    ...
                    sx={{
                      ...
                      textAlign: "center",
                      color: `${
                        ReduxStoredData?.fallbackFn === "Passed"
                          ? "white"
                          : "red"
                      }`,
